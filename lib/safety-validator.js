...
const FORBIDDEN_PATTERNS = [
  ...
  // brand names a model may substitute for the generic drug
  { label: 'drug:brand-hair', re: /\brogaine\b|\bregaine\b|\bpropecia\b|\bfin(pecia|ax|ast|cap)\b|\bavodart\b|\bdutas\b|\bnizoral\b|\bkeraglo\b|\bmintop\b|\btugain\b/i },
  { label: 'drug:brand-skin', re: /\bretino-?a\b|\bretin-?a\b|\bdifferin\b|\bepiduo\b|\bbenzac\b|\bclindamycin\b|\btreti(va|n)\b/i },
  { label: 'drug:dht', re: /\bdht\b[-\s]?(blocker|inhibitor)?|\bdihydrotestosterone\b/i },
  ...
  { label: 'supp:products', re: /\bfish\s*oil\b|\bomega[-\s]?3\b|\bwhey\b|\bzinc\b|\bmelatonin\b|\bcollagen\b|\bglutathione\b/i },
  { label: 'supp:vitamin-dose', re: /\bvitamin\s*[a-e]\d*\b|\bvit\.?\s*[a-e]\b/i },
  { label: 'supp:generic', re: /\bsupplements?\b|\bmultivitamins?\b|\bnootropics?\b|\bgummies\b/i },

  // — Procedures ————————————————————————————————————————————————
  { label: 'proc:microneedling', re: /\bmicro-?needling\b|\bderma-?(roller|pen|stamp)\b/i },
  { label: 'proc:transplant', re: /\b(hair\s*)?transplant\b|\bfue\b|\bfut\b|\bprp\b|\bgfc\b|\bqr\s?678\b|\bmesotherapy\b/i },
  ...
  // — Dosage / strength (tolerate obfuscating whitespace) ————————————
